	...
	if (f1==f2) {
		...
		for(int m=0;m<routB.size();m++){
			for(int n=0;n<routA.size();n++){
				...
				for (int i=0;i<routB[m].size()-1;i++)       {path[0][routA[n].size()+1+i] = map[routB[m][i].first];   path[1][2+i+routA[n].size()] = routB[m][i].second;}

				path[0][routA[n].size()+routB[m].size()] = map[routB[m][routB[m].size()-1].first];
...
int main(int argc, char **argv) {
   ...
   for(int i=0;i<5;i++)  sum  = sum + result_1[i].size()+ result_2[i].size()+ result_3[i].size()+ result_4[i].size() /*+ result_5[i].size() +result_6[i].size()+ result_7[i].size() + result_8[i].size() */;
	...
	for(int j=0;j<result_2[0].size();j++){
		printf("%d,%d,%d\n", result_2[0][j][0],result_2[0][j][1],result_2[0][j][2]); 
	}   //for result_2
	for(int j=0;j<result_3[0].size();j++){
		printf("%d,%d,%d\n", result_3[0][j][0],result_3[0][j][1],result_3[0][j][2]); 
	}   //for result_3
	for(int j=0;j<result_4[0].size();j++){
		printf("%d,%d,%d\n", result_4[0][j][0],result_4[0][j][1],result_4[0][j][2]); 
	}   //for result_4

	// length = 4
	for(int j=0;j<result_1[1].size();j++){
		printf("%d,%d,%d,%d\n", result_1[1][j][0],result_1[1][j][1],result_1[1][j][2],result_1[1][j][3]); 
	}   //for result_1
	for(int j=0;j<result_2[1].size();j++){
		printf("%d,%d,%d,%d\n", result_2[1][j][0],result_2[1][j][1],result_2[1][j][2],result_2[1][j][3]); 
	}   //for result_2
	for(int j=0;j<result_3[1].size();j++){
		printf("%d,%d,%d,%d\n", result_3[1][j][0],result_3[1][j][1],result_3[1][j][2],result_3[1][j][3]); 
	}   //for result_3
	for(int j=0;j<result_4[1].size();j++){
		printf("%d,%d,%d,%d\n", result_4[1][j][0],result_4[1][j][1],result_4[1][j][2],result_4[1][j][3]); 
	}   //for result_4

	// length = 5
	for(int j=0;j<result_1[2].size();j++){
		printf("%d,%d,%d,%d,%d\n", result_1[2][j][0],result_1[2][j][1],result_1[2][j][2],result_1[2][j][3],result_1[2][j][4]); 
	}   //for result_1
	for(int j=0;j<result_2[2].size();j++){
		printf("%d,%d,%d,%d,%d\n", result_2[2][j][0],result_2[2][j][1],result_2[2][j][2],result_2[2][j][3],result_2[2][j][4]); 
	}   //for result_2
	for(int j=0;j<result_3[2].size();j++){
		printf("%d,%d,%d,%d,%d\n", result_3[2][j][0],result_3[2][j][1],result_3[2][j][2],result_3[2][j][3],result_3[2][j][4]); 
	}   //for result_3
	for(int j=0;j<result_4[2].size();j++){
		printf("%d,%d,%d,%d,%d\n", result_4[2][j][0],result_4[2][j][1],result_4[2][j][2],result_4[2][j][3],result_4[2][j][4]); 
	}   //for result_4

	// length = 6
	for(int j=0;j<result_1[3].size();j++){
		printf("%d,%d,%d,%d,%d,%d\n", result_1[3][j][0],result_1[3][j][1],result_1[3][j][2],result_1[3][j][3],result_1[3][j][4],result_1[3][j][5]); 
	}   //for result_1
	for(int j=0;j<result_2[3].size();j++){
		printf("%d,%d,%d,%d,%d,%d\n", result_2[3][j][0],result_2[3][j][1],result_2[3][j][2],result_2[3][j][3],result_2[3][j][4],result_2[3][j][5]); 
	}   //for result_2
	for(int j=0;j<result_3[3].size();j++){
		printf("%d,%d,%d,%d,%d,%d\n", result_3[3][j][0],result_3[3][j][1],result_3[3][j][2],result_3[3][j][3],result_3[3][j][4],result_3[3][j][5]); 
	}   //for result_3
	for(int j=0;j<result_4[3].size();j++){
		printf("%d,%d,%d,%d,%d,%d\n", result_4[3][j][0],result_4[3][j][1],result_4[3][j][2],result_4[3][j][3],result_4[3][j][4],result_4[3][j][5]); 
	}   //for result_4

	// length = 7
	for(int j=0;j<result_1[4].size();j++){
		printf("%d,%d,%d,%d,%d,%d,%d\n", result_1[4][j][0],result_1[4][j][1],result_1[4][j][2],result_1[4][j][3],result_1[4][j][4],result_1[4][j][5],result_1[4][j][6]); 
	}   //for result_1
	for(int j=0;j<result_2[4].size();j++){
		printf("%d,%d,%d,%d,%d,%d,%d\n", result_2[4][j][0],result_2[4][j][1],result_2[4][j][2],result_2[4][j][3],result_2[4][j][4],result_2[4][j][5],result_2[4][j][6]); 
	}   //for result_2
	for(int j=0;j<result_3[4].size();j++){
		printf("%d,%d,%d,%d,%d,%d,%d\n", result_3[4][j][0],result_3[4][j][1],result_3[4][j][2],result_3[4][j][3],result_3[4][j][4],result_3[4][j][5],result_3[4][j][6]); 
	}   //for result_3
	for(int j=0;j<result_4[4].size();j++){
		printf("%d,%d,%d,%d,%d,%d,%d\n", result_4[4][j][0],result_4[4][j][1],result_4[4][j][2],result_4[4][j][3],result_4[4][j][4],result_4[4][j][5],result_4[4][j][6]); 
	}   //for result_4
   	// endss = clock();
	// cout<<(double)(endss-start)/CLOCKS_PER_SEC<<endl;
